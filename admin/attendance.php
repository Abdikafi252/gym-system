...
$members_qry = "SELECT user_id, fullname, contact, services, dor, paid_date, expiry_date FROM members WHERE status = 'Active' AND dor <= '$end_of_selected_month'" . $branch_where . " ORDER BY fullname ASC";
