...
$q1 = mysqli_query($con, "SELECT COUNT(*) as total FROM members WHERE status = 'Active' AND expiry_date >= '$today'");
$active_members = 0;
if ($q1) {
...
$q2 = mysqli_query($con, "SELECT COUNT(*) as total FROM members");
$r2 = mysqli_fetch_assoc($q2);
$total_members = $r2['total'];

// 3. Dakhliga Guud (Actual money received)
$q3 = mysqli_query($con, "SELECT SUM(paid_amount) as total FROM members");
...
// 5. Dakhliga Maanta
$q5 = mysqli_query($con, "SELECT SUM(paid_amount) as total FROM members WHERE paid_date = '$today'");
$r5 = mysqli_fetch_assoc($q5);
$today_collection = $r5['total'] ? $r5['total'] : 0;

// 6. Dakhliga Todobaadka
$q6 = mysqli_query($con, "SELECT SUM(paid_amount) as total FROM members WHERE paid_date >= '$last_7_days'");
...
$q9 = mysqli_query($con, "SELECT COUNT(*) as total FROM members WHERE paid_date = '$today' AND dor != '$today'");
$r9 = mysqli_fetch_assoc($q9);
$today_renewal = $r9['total'];

// 10. Cusboonaysiinta Bishaan
$q10 = mysqli_query($con, "SELECT COUNT(*) as total FROM members WHERE paid_date >= '$first_day_of_month' AND dor < '$first_day_of_month'");
$r10 = mysqli_fetch_assoc($q10);
$monthly_renewal = $r10['total'];

// 11. Cusboonaysiinta Dhiman
$q11 = mysqli_query($con, "SELECT COUNT(*) as total FROM members WHERE expiry_date < '$today'");
$r11 = mysqli_fetch_assoc($q11);
$pending_renewal = $r11['total'];

// 12. Haraaga Dhiman (Total Net - Paid for all members)
$q12 = mysqli_query($con, "SELECT SUM(amount - paid_amount) as total FROM members WHERE status = 'Active' AND amount > paid_amount");
$r12 = mysqli_fetch_assoc($q12);
$pending_balance = $r12['total'] ? (float)$r12['total'] : 0;

// 13. Dhicitaanka Maanta
$q13 = mysqli_query($con, "SELECT COUNT(*) as total FROM members WHERE expiry_date = '$today'");
$r13 = mysqli_fetch_assoc($q13);
$today_plan_expiry = $r13['total'];

// 14. Xubnaha Maanta Jooga (Only Active & Not Expired)
...
$q15 = mysqli_query($con, "SELECT COUNT(*) as total FROM members WHERE dor = '$today'");
$r15 = mysqli_fetch_assoc($q15);
$new_membership = $r15['total'];

// 16. Wadarta Shaqaalaha
$q16 = mysqli_query($con, "SELECT COUNT(*) as total FROM staffs");
if ($q16) {
...
$q17 = mysqli_query($con, "SELECT COUNT(*) as total FROM equipment");
if ($q17) {
...
$q18_1 = mysqli_query($con, "SELECT SUM(amount) as total FROM expenses");
$r18_1 = mysqli_fetch_assoc($q18_1);
$total_expenses_all = $r18_1['total'] ? $r18_1['total'] : 0;

$q18_2 = mysqli_query($con, "SELECT SUM(amount) as total FROM equipment");
...
// 20. Tababarayaasha
$q20 = mysqli_query($con, "SELECT COUNT(*) as total FROM staffs WHERE designation = 'Trainer' OR designation = 'Tababare'");
if ($q20) {
...
<div class="stats-grid">
    ...
    <a href="reports.php" class="stat-card">
        ...
        <div class="stat-content">
            <h4 class="stat-title">Foydada Guud (Net)</h4>
