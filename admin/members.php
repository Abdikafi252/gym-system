              ...
              while ($row = mysqli_fetch_array($result)) {
                ...
                if ($discount_type == 'percent') {
                  if ($discount_amount > 0 && $discount_amount < 100) {
                    $base_amount = $amount / (1 - ($discount_amount / 100));
                  }
                } else {
                ...
                $days_elapsed   = max(0, (int)((strtotime($today) - strtotime($row['dor'])) / 86400));
                ...
                if ($b_row = mysqli_fetch_assoc($b_qry)) $branch_name = $b_row['branch_name'];
        ...
        <div style="background:#fff; border-radius:12px; padding:20px; box-shadow:0 1px 4px rgba(0,0,0,0.07);">
          ...
          <div style="margin-top:14px; padding-top:14px; border-top:1px solid #f1f5f9; display:grid; grid-template-columns:1fr 1fr; gap:10px;">
            ...
            <div>
              ...
              <div id="mdl_email" style="font-size:13px; color:#334155;"></div>
            </div>
            <div>
        ...
        <div style="background:#fff; border-radius:12px; padding:20px; box-shadow:0 1px 4px rgba(0,0,0,0.07);">
          ...
          <div style="background:#f8fafc; border-radius:10px; padding:14px; margin-bottom:12px; display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:8px;">
            <div>
              ...
              <span style="background:#eff6ff; color:#1d4ed8; font-size:12px; font-weight:700; padding:3px 10px; border-radius:20px; display:inline-block; margin-top:4px;"><i class="fas fa-calendar-alt"></i> <span id="mdl_plan_badge"></span></span>
            </div>
