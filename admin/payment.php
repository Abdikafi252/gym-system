...
<body>
  ...
  <style>
    ...
    @media (max-width: 767px) {
      ...
      .payment-shell .payment-fit-wrap.mode-compact table.payment-fullview td:nth-child(2) { width: 14%; }
      .payment-shell .payment-fit-wrap.mode-compact table.payment-fullview th:nth-child(3),
      .payment-shell .payment-fit-wrap.mode-compact table.payment-fullview td:nth-child(3) { width: 12%; }
      .payment-shell .payment-fit-wrap.mode-compact table.payment-fullview th:nth-child(4),
      .payment-shell .payment-fit-wrap.mode-compact table.payment-fullview td:nth-child(4) { width: 8%; }
      ...
      .payment-shell .payment-fit-wrap.mode-compact table.payment-fullview td:nth-child(6) { width: 8%; }
      ...
      .payment-shell .payment-fit-wrap.mode-compact table.payment-fullview td:nth-child(8) { width: 12%; }
      .payment-shell .payment-fit-wrap.mode-compact table.payment-fullview th:nth-child(9),
      .payment-shell .payment-fit-wrap.mode-compact table.payment-fullview td:nth-child(9) { width: 8%; }
      .payment-shell .payment-fit-wrap.mode-compact table.payment-fullview th:nth-child(10),
      .payment-shell .payment-fit-wrap.mode-compact table.payment-fullview td:nth-child(10) { width: 9%; }
      .payment-shell .payment-fit-wrap.mode-compact table.payment-fullview th:nth-child(11),
      .payment-shell .payment-fit-wrap.mode-compact table.payment-fullview td:nth-child(11) { width: 9%; }
  ...
  <script type="text/javascript">
    ...
    (function() {
      ...
      function setMode(mode) {
        ...
        try {
          localStorage.setItem('paymentTableMode', isCompact ? 'compact' : 'readable');
        } catch (e) {}
      }
      ...
      var saved = null;
      try {
        saved = localStorage.getItem('paymentTableMode');
      } catch (e) {}
