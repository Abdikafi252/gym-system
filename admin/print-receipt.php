...
<head>
    ...
    <style>
        ...
        .thermal-receipt { width: 320px; background: #fff; padding: 12px; color: #000; margin: 0 auto; box-sizing: border-box; border: 1px solid #eee; box-shadow: 0 4px 15px rgba(0,0,0,0.1); }
    ...
    <div class="receipt-wrapper">
        <div id="print-area" class="thermal-receipt">
            ...
            <div class="thermal-row" style="flex-wrap: wrap;">
                <span>Member:</span>
                <span style="text-align:right"><?php echo htmlspecialchars($hist_row['fullname']); ?></span>
            </div>
            <div class="thermal-row">
                <span>Member ID:</span>
