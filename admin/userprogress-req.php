    ...
    <div id="content">
        ...
        <form role="form" action="index.php" method="POST">
            ...
            if (isset($_POST['ini_weight'])) {
                ...
                $chest = $_POST["chest"];
                $waist = $_POST["waist"];
                $neck = isset($_POST["neck"]) ? $_POST["neck"] : '0';
                ...
                //update query
                $qry = "update members set ini_weight='$ini_weight', curr_weight='$curr_weight', ini_bodytype='$ini_bodytype', curr_bodytype='$curr_bodytype', height='$height', chest='$chest', waist='$waist', neck='$neck', hip='$hip', thigh='$thigh', arms='$arms', fat='$fat', progress_date='$curr_date' where user_id='$id'";
