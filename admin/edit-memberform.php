    ...
    <div id="content">
      ...
      <div class="container-fluid">
        ...
        <form action="edit-member-req.php" method="POST" enctype="multipart/form-data">
          ...
          <!-- Document -->
          <div class="form-section">
            <div class="form-section-title">Dukumiintiga (Documents) :</div>
            <div class="form-group-row">
              <div class="form-col">
                <label class="custom-label">Aadhar Number (Tirsi Aqoonsi)</label>
                <div class="input-wrapper">
              ...
              <div class="form-col">
                ...
                <div class="radio-group" style="padding-left:15px;">
                  <label class="radio-label">
                    <input type="radio" name="discount_type" value="percent" <?php echo ($row['discount_type'] == 'percent') ? 'checked' : ''; ?> onchange="calculateTotal()"> Boqolkiiba (%)
                  </label>
                  <label class="radio-label">
                    <input type="radio" name="discount_type" value="amount" <?php echo ($row['discount_type'] == 'amount') ? 'checked' : ''; ?> onchange="calculateTotal()"> Lacag ahaan ($)
                  </label>
                </div>
              </div>
              <div class="form-col">
              ...
              <div style="background:#eff6ff; padding:15px; border-radius:8px; border:1px solid #bfdbfe; margin-top:20px; width:100%;">
                ...
                <div style="display: flex; gap: 15px; margin-top: 15px; flex-wrap: wrap;">
                  ...
                  <div style="flex: 1; min-width: 120px; background: #fff; padding: 10px; border-radius: 6px; border: 1px solid #bfdbfe; text-align: center;">
                    <span style="display: block; font-size: 11px; color: #1d4ed8; font-weight: 600; text-transform: uppercase;">Lacagta Guud (Net Total)</span>
            ...
            <div class="form-group-row">
              <div class="form-col">
                ...
                <div class="radio-group">
                  ...
                  <label class="radio-label">
                    <input type="radio" name="trainer_type" value="General Training" <?php echo ($row['trainer_type'] == 'General Training' || $row['trainer_type'] == '') ? 'checked' : ''; ?>> Tababar Guud (General Training)
                  </label>
                  <label class="radio-label">
                    <input type="radio" name="trainer_type" value="Personal" <?php echo ($row['trainer_type'] == 'Personal') ? 'checked' : ''; ?>> Tababarihi Gaar ah (Personal)
                  </label>
                </div>
              </div>
            </div>
  ...
  <script type="text/javascript">
    ...
    function previewFile() {
      ...
      if (file) {
        ...
        // If no file selected, reset to existing photo if any
        // For simplicity in edit, we just keep the preview as is or reset if empty
      }
    }
