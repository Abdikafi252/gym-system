...
$branch_where1 = $branch_id > 0 ? " WHERE branch_id = $branch_id " : "";
$qry = "SELECT gender, count(*) as number FROM members $branch_where1 GROUP BY gender";
...
<head>
  ...
  <script type="text/javascript">
    ...
    function drawChart() {
      ...
      var options = {
        title: 'Gym Member Percentage by Gender',
        //is3D:true,  
        pieHole: 0.0
      };
  ...
  <script type="text/javascript">
    ...
    function drawStuff() {
      var data = new google.visualization.arrayToDataTable([
        ...
        <?php
        $branch_id = isset($_SESSION['branch_id']) ? (int)$_SESSION['branch_id'] : 0;
        $branch_where2 = $branch_id > 0 ? " WHERE branch_id = $branch_id " : "";
        $query1 = "SELECT gender, SUM(amount) as numberone FROM members $branch_where2; ";
        ...
        <?php
        $branch_id = isset($_SESSION['branch_id']) ? (int)$_SESSION['branch_id'] : 0;
        $branch_where3 = $branch_id > 0 ? " WHERE branch_id = $branch_id " : "";
        $query10 = "SELECT quantity, SUM(amount) as numbert FROM equipment $branch_where3";
  ...
  <script type="text/javascript">
    ...
    function drawStuff() {
      var data = new google.visualization.arrayToDataTable([
        ...
        <?php
        $branch_id = isset($_SESSION['branch_id']) ? (int)$_SESSION['branch_id'] : 0;
        $branch_where4 = $branch_id > 0 ? " WHERE branch_id = $branch_id " : "";
        $query = "SELECT services, count(*) as number FROM members $branch_where4 GROUP BY services";
