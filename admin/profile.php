...
<body>
    ...
    <div id="content">
        <div id="content-header">
            ...
            <h1 class="text-center">Admin Profile Settings <i class="fas fa-cogs"></i></h1>
        </div>
                        ...
                        <div class="widget-content nopadding">
                            <form action="update-profile-req.php" method="POST" class="form-horizontal" enctype="multipart/form-data">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <img src="../<?php echo isset($row['photo']) && !empty($row['photo']) ? $row['photo'] : 'img/user.png'; ?>" alt="Profile" style="width: 100px; height: 100px; border-radius: 50%; border: 3px solid #eee;">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="file" name="profile_pic" class="span11" accept="image/*" />
                                        <span class="help-block">Leave blank to keep the current picture.</span>
                                    </div>
                                </div>
