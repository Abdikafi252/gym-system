                  ...
                  <div class="control-group">
                    <div class="avatar-upload">
                      ...
                      <div class="avatar-preview">
                        <div id="imagePreview" style="background-image: url('<?php echo $photo_path; ?>');"></div>
                      </div>
                    </div>
                  </div>
                  <div class="control-group">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <select name="designation" id="designation">
                        <option value="Cashier" <?php if ($row['designation'] == 'Cashier') echo 'selected'; ?>>Cashier</option>
                        <option value="Trainer" <?php if ($row['designation'] == 'Trainer') echo 'selected'; ?>>Trainer</option>
                        <option value="Trainer Assistant" <?php if (in_array($row['designation'], ['Trainer Assistant', 'GYM Assistant'])) echo 'selected'; ?>>Trainer Assistant</option>
                        <option value="Manager" <?php if ($row['designation'] == 'Manager') echo 'selected'; ?>>Manager</option>
                        <option value="Cleaner" <?php if (in_array($row['designation'], ['Cleaner', 'Security'])) echo 'selected'; ?>>Cleaner</option>
                      </select>
                    </div>
                  </div>
