...
// Ensure staff only sees members in their branch
if (isset($_SESSION['branch_id'])) {
  $branch_id = $_SESSION['branch_id'];
  $members_qry = "SELECT user_id, fullname, contact, services, dor, paid_date, expiry_date FROM members WHERE status = 'Active' AND branch_id='$branch_id' AND dor <= '$end_of_selected_month' ORDER BY fullname ASC";
} else {
