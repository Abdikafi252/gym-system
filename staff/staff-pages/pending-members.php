...
$qry = "SELECT user_id, fullname, username, contact, services, plan, dor, status
  FROM members
  WHERE status='Pending' AND (branch_id='$branch_id' OR branch_id IS NULL OR branch_id='0')
            ...
            <div class="widget-content nopadding">
              <table class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  ?>
                  <tr>
                    <td colspan="9" class="text-center" style="padding:20px;">Pending members ma jiraan.</td>
                  </tr>
                  <?php endif; ?>
                </tbody>
              </table>
