        ...
        <form action="add-member-req.php" method="POST" enctype="multipart/form-data">
              ...
              <div style="flex: 1; min-width: 300px;">
                <div class="form-group-row">
                  <div class="form-col">
                    ...
                    <div class="input-wrapper">
                      ...
                      <input type="text" class="custom-input" name="fullname" placeholder="Geli Magaca oo buuxa" required />
                    </div>
                  </div>
                  <div class="form-col">
                ...
                <div class="form-group-row">
                  ...
                  <div class="form-col">
                    ...
                    <div class="input-wrapper">
                      ...
                      <input type="number" class="custom-input" name="contact" placeholder="Tusaale: 61xxxxxxx" required />
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group-row">
                  <div class="form-col form-col-full">
                    ...
                    <div class="input-wrapper">
                      <textarea name="address" class="custom-input" style="padding-left:15px !important; height:auto !important;" rows="2" placeholder="Geli cinwaanka qofka..." required></textarea>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="form-section">
                ...
                <div class="input-wrapper">
                  ...
                  <select name="plan" id="plan" class="custom-input" style="padding-left:35px !important;" onchange="calculateExpiry()" required>
                    ...
                    while ($pkg = mysqli_fetch_array($resPkgs)) {
                      echo "<option value='" . $pkg['duration'] . "'>" . $pkg['packagename'] . " (" . $pkg['duration'] . " Bilood)</option>";
                    }
                    ?>
                  </select>
                </div>
                ...
                <div class="input-wrapper">
                  ...
                  <select name="services" id="services" class="custom-input" style="padding-left:35px !important;" onchange="updateAmount()" required>
                    ...
                    while ($rate = mysqli_fetch_array($resRates)) {
                      echo "<option value='" . $rate['name'] . "' data-charge='" . $rate['charge'] . "'>" . $rate['name'] . " - $" . $rate['charge'] . " bishiiba</option>";
                    }
                    ?>
                  </select>
                </div>
            ...
            <div class="form-group-row">
              <div class="form-col form-col-full">
                ...
                <div class="input-wrapper">
                  ...
                  <textarea name="comments" class="custom-input" style="height:auto !important; padding-left:35px !important;" rows="2" placeholder="Geli faahfaahin dheeraad ah..."></textarea>
                </div>
              </div>
            </div>
            ...
            <div style="text-align: right; margin-top: 15px;">
              <button type="submit" class="btn-save"><i class="fas fa-save" style="margin-right:8px;"></i> Kaydso (Save)</button>
            </div>
          </div>
          ...
          <div class="action-buttons">
            <button type="submit" class="btn btn-save" name="submit">LABA-SOO (SAVE)</button>
          </div>
