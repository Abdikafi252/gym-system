    ...
    <div id="loginbox">
        <form id="loginform" method="POST" class="form-vertical" action="#">
            ...
            <div class="form-actions center">
                <span class="pull-right"><button type="submit" class="btn btn-success" title="Log In" name="login" value="Admin Login">Login</button></span>
            </div>
        </form>
        <?php
        if (isset($_POST['login'])) {
            ...
            $password = $_POST['pass'];
            $attemptKey = 'admin|' . strtolower($rawUser) . '|' . get_client_ip();
            ...
            $query = mysqli_prepare($con, "SELECT user_id, password FROM admin WHERE username=?");
            mysqli_stmt_bind_param($query, "s", $username);
            mysqli_stmt_execute($query);
            mysqli_stmt_bind_result($query, $user_id, $db_password);
            ...
            if (!empty($db_password)) {
                if (password_verify($password, $db_password)) {
                    ...
                    $update_query = mysqli_prepare($con, "UPDATE admin SET password=? WHERE user_id=?");
